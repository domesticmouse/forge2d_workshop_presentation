...
Step _$StepFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    ...
    final val = Step(
      ...
      displayMarkdown: $checkedConvert('display-markdown', (v) => v as String?),
      ...
      tree: $checkedConvert(
        'tree',
        (v) =>
            (v as List<dynamic>?)?.map((e) => Node.fromJson(e as Map)).toList(),
      ),
    );
    return val;
  },
...
SubStep _$SubStepFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    ...
    final val = SubStep(
      ...
      extentOffset: $checkedConvert('extent-offset', (v) => (v as num).toInt()),
